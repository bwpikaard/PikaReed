    ...
    return (
        <>
            <div className="pt-10 flex justify-center">
                <h1 className="mb-4 text-4xl tracking-tight font-extrabold text-white">Chapter Title</h1>
            </div>
            
            <div className="grid grid-cols-7 pt-10">
                <div className="col-start-2 col-span-5 pb-5 flex justify-between items-center">
                    <Link href="#" className="inline-flex items-center px-4 py-2 mr-3 text-sm font-medium text-white bg-mute-black rounded-lg hover:text-basically-white focus:ring-basically-white focus:ring-4">
                ...
                <div className="col-start-2 col-span-5">
                    <section className="py-8 lg:py-16">
                        <div className="max-w-fit mx-auto px-4">
                            ...
                            <article className="p-6 mb-6 text-base bg-mute-black rounded-lg">
                                <footer className="flex justify-between items-center mb-2">
                                    ...
                                    <button id="dropdownComment1Button" data-dropdown-toggle="dropdownComment1"
                                        className="inline-flex items-center p-2 text-sm font-medium text-center text-white bg-greyish rounded-lg hover:text-basically-white focus:ring-4 focus:outline-none focus:ring-basically-white"
                                        type="button">
                                    ...
                                    <div id="dropdownComment1"
                                        className="hidden z-10 w-36 bg-mute-black rounded divide-y divide-gray-100 shadow border border-greyish">
                                        <ul className="py-1 text-sm text-white"
                                            aria-labelledby="dropdownMenuIconHorizontalButton">
                                            <li>
                                                <a href="#"
                                                    className="block py-2 px-4 hover:text-basically-white">Edit</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    className="block py-2 px-4 hover:text-basically-white">Remove</a>
                                            </li>
                                            <li>
                                                <a href="#"
                                                    className="block py-2 px-4 hover:text-basically-white">Report</a>
                                            </li>
                                        </ul>
                                    </div>
                                </footer>
                                ...
                                <div className="flex items-center mt-4 space-x-4">
                                    <button type="button"
                                        className="flex items-center text-sm text-white hover:text-basically-white">
                                        <svg aria-hidden="true" className="mr-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                                        Reply
                                    </button>
                                </div>
                            </article>
                            <article className="p-6 mb-6 ml-6 lg:ml-12 text-base bg-mute-black rounded-lg">
                                <footer className="flex justify-between items-center mb-2">
                                    <div className="flex items-center">
                                        <p className="inline-flex items-center mr-3 text-sm text-white"><Image
                                            className="mr-2 w-10 h-10 rounded-full"
                                        ...
                                        <p className="text-sm text-white"><time dateTime="2022-02-12"
                            ...
                            <article className="p-6 mb-6 text-base bg-mute-black rounded-lg">
                                <footer className="flex justify-between items-center mb-2">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-white"><time dateTime="2022-03-12"
                            ...
                            <article className="p-6 text-base bg-mute-black rounded-lg">
                                <footer className="flex justify-between items-center mb-2">
                                    <div className="flex items-center">
                                        <p className="inline-flex items-center mr-3 text-sm text-white"><Image
                                            className="mr-2 w-10 h-10 rounded-full"
                                        ...
                                        <p className="text-sm text-white"><time dateTime="2022-06-23"
