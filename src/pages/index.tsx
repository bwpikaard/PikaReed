            ...
            <div className="flex h-full bg-mute-black grid grid-cols-5">
                ...
                <div className="col-span-1 pt-8">
                    <div className="flex flex-wrap">
                        <span className="bg-greyish text-white text-md font-medium mt-2 mr-2 px-4 py-1 rounded">Action</span>
                        <span className="bg-greyish text-white text-md font-medium mt-2 mr-2 px-4 py-1 rounded">Adventure</span>
                        <span className="bg-greyish text-white text-md font-medium mt-2 mr-2 px-4 py-1 rounded">Horror</span>
                        <span className="bg-greyish text-white text-md font-medium mt-2 mr-2 px-4 py-1 rounded">Thriller</span>
                        <span className="bg-greyish text-white text-md font-medium mt-2 mr-2 px-4 py-1 rounded">Mystery</span>
                        <span className="bg-greyish text-white text-md font-medium mt-2 mr-2 px-4 py-1 rounded">Sci-Fi</span>
                    </div>
                </div>
            </div>
        </Link>;
